...
class PrimaryContentViewController: UIViewController {
    ...
    func createMapPin(searchTerm: String, business: Business)  {
        
        let coord = CLLocationCoordinate2DMake(business.latitude!, business.longitude!)
        let annotation = CustomAnnotation(title: business.name!, subtitle: business.distance!, coordinate: coord, imageName: searchTerm, searchTerm: searchTerm, business: business)
        
        print(annotation.business?.name)
        self.updateImage(searchTerm, annotation: annotation, business: business)
        
        self.map.addAnnotation(annotation)
        
    }
    
    func updateImage(searchTerm: String, annotation: CustomAnnotation, business: Business?) {
            ...
            business!.categories!.rangeOfString("Asian") != nil
        {
            ...
            annotation.imageName = searchTerm
        }
    }
...
extension PrimaryContentViewController: MKMapViewDelegate {
    ...
    func mapView(mapView: MKMapView,
        ...
        av?.searchTerm = customAnnotation.searchTerm
    ...
    func showDetailView(sender: AnyObject, business: Business?, searchTerm: String?) {
        ...
        detailVC.searchTerm = searchTerm
    ...
    func mapView(mapView: MKMapView, annotationView view: MKAnnotationView, calloutAccessoryControlTapped control: UIControl) {
        ...
        if Reachability.isConnectedToNetwork() && locationFound == true {

        if control.tag == 1 {
            
            self.showDetailView(control, business: view.business!, searchTerm: view.searchTerm)
        }
